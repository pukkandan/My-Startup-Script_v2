...
global SCR_Name
SplitPath(A_ScriptName, , , , SCR_Name)        ;SCR_Name = Name of file without extension

global SCR_PID := ProcessExist() ; Script's PID
DetectHiddenWindows(True)
global SCR_hwnd := WinExist("ahk_pid " SCR_PID) ; Script's hwnd
...
;;Hotstring("MouseReset",True)  ;Mouse is not used to reset hotstrings
